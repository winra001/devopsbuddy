...
public class S3Service {
	...
	public String storeProfileImage(MultipartFile uploadedFile, String username) {
		...
		try {
			if (uploadedFile != null && !uploadedFile.isEmpty()) {
				...
				File tmpImageStoredFolder = new File(tempImageStore + File.separator + username);
	...
	/**
	 * It stores the given file name in S3 and returns the key under which the
