...
public class SignupController {
	...
	public String signupPost(@RequestParam(name = "planId", required = true) int planId,
        ...
        Plan selectedPlan = planService.findByPlanById(planId);
		...
		if (planId == PlansEnum.BASIC.getId()) {
			roles.add(new UserRole(registeredUser, new Role(RolesEnum.BASIC)));
			registeredUser = userService.createUser(user, PlansEnum.BASIC, roles);
		} else {
			roles.add(new UserRole(registeredUser, new Role(RolesEnum.PRO)));
